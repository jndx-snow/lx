...
public class MipcaActivityCapture extends Activity implements Callback , View.OnClickListener{
	...
	public Result scanningImage(String path) {
		...
		options.inJustDecodeBounds = false; // ???????С
...
//		resultIntent.putExtras(bundle);
		...
		if(getIntent().getSerializableExtra("advice_right") != null){
			...
			Bundle bundle = new Bundle();
			bundle.putString("ll","true");
			bundle.putSerializable("advice_right", (Advice)getIntent().getSerializableExtra("advice_right"));
			resultIntent.putExtras(bundle);
		}else if(getIntent().getSerializableExtra("advice_left") != null){
			Bundle bundle = new Bundle();
			bundle.putString("ll","");
			bundle.putSerializable("advice_left", (Advice)getIntent().getSerializableExtra("advice_left"));
			resultIntent.putExtras(bundle);
