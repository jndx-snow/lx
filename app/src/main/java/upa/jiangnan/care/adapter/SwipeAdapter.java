...
public class SwipeAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		if(convertView == null){
			...
			TextView sex_tip_view = (TextView) convertView.findViewById(R.id.sex_tip);
...
//					checkDialog.show();
					...
					checkDialog.getWindow().findViewById(R.id.patian_confirm).setOnClickListener(new OnClickListener() {
			...
			//后端的button响应
			Button call_record_btn_patient = (Button) convertView.findViewById(R.id.call_record_btn_patient);
			Button base_info_btn = (Button) convertView.findViewById(R.id.base_info_btn);
			Button call_btn_patient = (Button) convertView.findViewById(R.id.call_btn_patient);

			call_record_btn_patient.setOnClickListener(new OnClickListener() {
			...
			call_btn_patient.setOnClickListener(new OnClickListener() {
