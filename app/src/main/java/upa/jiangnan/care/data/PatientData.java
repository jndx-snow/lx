...
public class PatientData {
	...
	public void insertPatientData() {
		...
		values_1.put("to_doctor_name", "责任医师：王幸");
		values_1.put("cure_detail", "诊断：煤工尘肺壹期  肺痿病");
		...
		values_2.put("to_doctor_name", "责任医师：王幸");
		values_2.put("cure_detail", "诊断：水泥尘肺壹期  肺痿病");
		...
		values_3.put("to_doctor_name", "责任医师：王幸");
		values_3.put("cure_detail", "诊断：水泥尘肺壹期  肺痿病");
		...
		values_4.put("to_doctor_name", "责任医师：王幸");
		values_4.put("cure_detail", "诊断：煤工尘肺壹期  肺痿病");
		...
		values_5.put("to_doctor_name", "责任医师：王幸");
		values_5.put("cure_detail", "诊断：煤工尘肺壹期  肺痿病");
		...
		values_6.put("to_doctor_name", "责任医师：王幸");
		values_6.put("cure_detail", "诊断：煤工尘肺壹期  肺痿病");
		...
		values_7.put("to_doctor_name", "责任医师：王丽");
		values_7.put("cure_detail", "诊断：煤工尘肺壹期  肺痿病");
		...
		values_8.put("to_doctor_name", "责任医师：王丽");
		values_8.put("cure_detail", "诊断：煤工尘肺壹期  肺痿病");
		...
		values_9.put("to_doctor_name", "责任医师：王美丽");
		values_9.put("cure_detail", "诊断：煤工尘肺壹期  肺痿病");
